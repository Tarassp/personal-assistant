...
class CliNotes:
    ...
    def show_all_handler(self):
        return self.notesbook


    def save_handler(self):
        return self.storage.save(self.notesbook)


    def load_handler(self):
        try:
            self.notesbook = self.storage.restore()
            print("Your note_book has been opened")
        except FileNotFoundError:
            self.notesbook = NoteBook()
            print("Your note_book has been created")
